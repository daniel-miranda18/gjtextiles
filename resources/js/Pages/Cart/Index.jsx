                    ...
                    {cartItems.length > 0 ? (
                        ...
                        <div class="hidden lg:grid grid-cols-2 py-6">
                            ...
                            <div class="flex items-center flex-col sm:flex-row justify-center gap-3 mt-8">
                                ...
                                <Link href={route("paypal.payment")} className="rounded-full w-full max-w-[280px] py-4 text-center justify-center items-center bg-indigo-600 font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700">
