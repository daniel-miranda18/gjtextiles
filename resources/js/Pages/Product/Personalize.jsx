                            ...
                            <div className="data w-full max-w-xl">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <input type="text" 
                                        name="product_id" 
                                        value={product.id} 
                                        onChange={(e) => setData("product_id", product.id)} 
                                    />
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 my-2">
                                        <div className="flex sm:items-center sm:justify-center w-full">
                                            <button onClick={(e) => decreaseQuantity(e)} className="group py-4 px-6 border border-gray-400 rounded-l-full bg-white transition-all duration-300 hover:bg-gray-50 hover:shadow-sm hover:shadow-gray-300">
                                            ...
                                            <button onClick={(e) => increaseQuantity(e)} className="group py-4 px-6 border border-gray-400 rounded-r-full bg-white transition-all duration-300 hover:bg-gray-50 hover:shadow-sm hover:shadow-gray-300">
                                                <svg className="stroke-gray-900 group-hover:stroke-black" width="16" height="16" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <button type="submit" className="group py-2 px-5 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-lg w-full flex items-center justify-center gap-2 transition-all duration-500 hover:bg-indigo-100" disabled={addToCartDisabled}>
